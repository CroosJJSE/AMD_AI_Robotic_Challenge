...
class SlamProcessorNode : public rclcpp::Node
{
public:
    SlamProcessorNode()
        : Node("slam_processor_node")
    {
        // Declare parameters
        ...
        image_sub_ = this->create_subscription<sensor_msgs::msg::Image>(
            "camera/image_raw", 10, std::bind(&SlamProcessorNode::image_callback, this, std::placeholders::_1));
    }
...
private:
    void image_callback(const sensor_msgs::msg::Image::SharedPtr msg)
    {
        ...
        // Process the image with ORB-SLAM3
...
int main(int argc, char **argv)
{
    ...
    rclcpp::spin(std::make_shared<SlamProcessorNode>());
    rclcpp::shutdown();
    return 0;
}
